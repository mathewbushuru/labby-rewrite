  ...
  private async addTaskPostgres(newTask: NewTaskType) {
    try {
      ...
      const createdTask: TaskType = {
        ...
        taskCategoryPosition: taskRows[0].task_category_position,
  ...
  private async addTaskMysql(newTask: NewTaskType) {
    try {
      ...
      const createdTask: TaskType = {
        ...
        taskCategoryPosition: rows[0].task_category_position,
  ...
  private async loadAllTasksPostgres() {
    try {
      ...
      const allTasks: TaskType[] = taskRows.map((dbTask) => ({
        ...
        taskCategoryPosition: dbTask.task_category_position,
